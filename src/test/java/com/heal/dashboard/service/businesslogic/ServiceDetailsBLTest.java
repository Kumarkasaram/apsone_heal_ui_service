...
//	      setting up mock data in  Controller
	    ...
	    public void getClientValidation_Success() throws Exception {
	        ...
	        Assert.assertEquals("7640123a-fbde-4fe5-9812-581cd1e3a9c1", serviceDetailsBL.clientValidation(requestObject).getAuthToken());
	    }
	    ...
	    public void getClientValidation_ClientException1() throws ClientException {
	        ...
	        serviceDetailsBL.clientValidation(requestObject);
	    ...
	    public void serverValidation() throws Exception {
	    	  Map<String,String> params = new HashMap<String,String>();
		        ...
		        params.put("serviceId", "2");
		        params.put("ndegree", "1");
		    	UtilityBean<String> utilityBean = UtilityBean.<String>builder().authToken("7640123a-fbde-4fe5-9812-581cd1e3a9c1").accountIdentifier("7640123a-fbde-4fe5-9812-581cd1e3a9c1").params(params).build();
	           ...
	           Mockito.when(acountDao.getAccountDetails(Mockito.anyString(), Mockito.anyString())).thenReturn(accountBeansList);
		        ...
		        Mockito.when(topologyUtiliBL.getNodeList(Mockito.any(), Mockito.any(),Mockito.anyInt(), Mockito.anyLong())).thenReturn(nodeslist);
